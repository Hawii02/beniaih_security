...
const GuardStatsCard = () => {
  ...
  return (
    <div className="gap-4 w-full h-1/4">
      <div className="rounded-lg h-full gap-4 max-lg:flex-col flex items-center justify-between">
      ...
      <div className="mt-8 h-3/4">
        <div className="flex items-center justify-between py-4">
          ...
          <Dialog open={isVisitorOpen} onOpenChange={setIsVisitorOpen}>
            <DialogTrigger asChild>
              ...
              >
                <PlusCircle />
                <p className="max-lg:hidden">Create New Visitor</p>
              </Button>
            </DialogTrigger>
            <DialogContent>
        ...
        <div className="overflow-x-auto rounded-lg border max-w-6xl p-3 bg-white shadow-sm">
          <Table columns={columns} data={paginatedVisitors} />
